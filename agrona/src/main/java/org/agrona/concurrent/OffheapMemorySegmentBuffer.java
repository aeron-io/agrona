...
public class OffheapMemorySegmentBuffer implements AtomicBuffer
{
    private final long addressOffset;
    private final int capacity;

    public OffheapMemorySegmentBuffer(final ByteBuffer buffer)
    {
        if (!buffer.isDirect())
        {
        ...
        this.addressOffset = MemorySegment.ofBuffer(buffer.duplicate().clear()).address();
    ...
    {
        return MemorySegment.ofAddress(addressOffset).reinterpret(capacity);
    }
